...
public interface CouponRepo extends CrudRepository<Coupon, Integer> {
	 ...
	 */
	 ...
	 /**Get all Coupons up to Date given
	  * Getting Coupons 
	  * @param date
	  * @param comapnyId
	  * @return
	 ...
	 ArrayList<Coupon> findwhereCouponDateLaserThenDateGiven (@Param ("endDate") Date date, @Param ("companyId") long comapnyId);
	 ...
	 ArrayList<Coupon> findbytypeAndCustomerId(CouponType type, int id);
